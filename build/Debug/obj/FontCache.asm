; Listing generated by Microsoft (R) Optimizing Compiler Version 19.29.30153.0 
	...
	TITLE	C:\TouchGFXProjects\WheelListDemo\build\Debug\obj\FontCache.obj
	.686P
	.XMM
	include listing.inc
	.model	flat
...
__1E853C77_FontCache@hpp DB 01H
__68DE72EE_ConstFont@hpp DB 01H
__238B092C_GeneratedFont@hpp DB 01H
__12B79344_CachedFont@hpp DB 01H
__1062B076_FontCache@cpp DB 01H
msvcjmc	ENDS
...
PUBLIC	??_C@_1KI@GFMLIKMN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ ; `string'
...
??_C@_1IE@NPIIMJBA@?$AAt?$AAy?$AAp?$AAe?$AAd?$AAT?$AAe?$AAx?$AAt?$AAs?$AA?5?$AA?$CB?$AA?$DN?$AA?5?$AA0@ DB 't'
	...
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_1KI@GFMLIKMN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
CONST	SEGMENT
??_C@_1KI@GFMLIKMN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@ DB 'C'
...
; _this$ = ecx
; File C:\TouchGFXProjects\WheelListDemo\generated\fonts\include\fonts\CachedFont.hpp
; Line 82
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __12B79344_CachedFont@hpp
...
; _this$ = ecx
; File C:\TouchGFXProjects\WheelListDemo\generated\fonts\include\fonts\FontCache.hpp
; Line 76
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __1E853C77_FontCache@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 77
	mov	eax, DWORD PTR _this$[ebp]
...
; _this$ = ecx
; File C:\TouchGFXProjects\WheelListDemo\generated\fonts\src\FontCache.cpp
; Line 418
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __1062B076_FontCache@cpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 419
	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+40], 0
...
$LN3@getTextDir:
	mov	esi, esp
	push	144					; 00000090H
	push	OFFSET ??_C@_1KI@GFMLIKMN@?$AAC?$AA?3?$AA?2?$AAT?$AAo?$AAu?$AAc?$AAh?$AAG?$AAF?$AAX?$AAP?$AAr?$AAo?$AAj@
...
; _this$ = ecx
; File C:\TouchGFXProjects\WheelListDemo\touchgfx\framework\include\touchgfx\Font.hpp
; Line 482
	push	ebp
	mov	ebp, esp
	sub	esp, 204				; 000000ccH
	...
	pop	ecx
	mov	DWORD PTR _this$[ebp], ecx
	mov	ecx, OFFSET __4C96F3A0_Font@hpp
	call	@__CheckForDebuggerJustMyCode@4
; Line 483
	fldz
; Line 484
